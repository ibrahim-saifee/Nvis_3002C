Public Class LTSettings
    ...
    Private Sub OKButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OKButton.Click
        MainForm.LTHysterisis = HysterisisUpDn.Value
        MainForm.LTProportionalConstant = KpTrackBar._Valeur / 100
        MainForm.LTIntegralConstant = (KpTrackBar._Valeur / TiTrackBar._Valeur) * 5
        MainForm.LTDerivativeConstant = (KpTrackBar._Valeur * TdTrackBar._Valeur) / 5
        If OnOffRadio.Checked = True Then MainForm.LevelTimer.Interval = 1000 Else MainForm.LevelTimer.Interval = 5000
        Me.Close()
    End Sub
